...
function App() {
  ...
  return (
    // ROOT CONTAINER:
    // Mobile: h-[100dvh] ensures full viewport usage on mobile browsers.
    // Desktop: md:h-screen and flex centering creates the "floating card" aesthetic.
    <div className="relative h-[100dvh] w-full bg-[#EFECE2] font-sans text-rialo-black md:flex md:h-screen md:items-center md:justify-center md:p-6 overflow-hidden">
      ...
      {/* --- MAIN CARD --- */}
      {/* Mobile: Full width/height, no radius, no border. */}
      {/* Desktop: Max width/height, rounded, bordered. */}
      <div className="
        relative z-10 flex flex-col overflow-hidden transition-all duration-700
        w-full h-full 
        md:w-full md:max-w-5xl md:h-[92vh] md:max-h-[1080px] 
