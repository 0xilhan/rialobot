...
function App() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden font-sans text-rialo-black bg-[#EFECE2] flex items-center justify-center">
      ...
      {/* Cube 1 */}
      <div className="absolute top-[15%] left-[10%] opacity-20 animate-float-slow pointer-events-none scale-[0.7] md:scale-100">
         <Box size={120} strokeWidth={0.5} className="text-rialo-black animate-spin-slow" />
      </div>
      
      {/* Cube 2 */}
      <div className="absolute bottom-[20%] right-[5%] opacity-10 animate-float-delayed pointer-events-none scale-[0.6] md:scale-100">
         <Box size={200} strokeWidth={0.5} className="text-rialo-black animate-reverse-spin-slow" />
      </div>

      {/* Gradient Orbs */}
      <div className="absolute top-[-10%] right-[-5%] w-[60vw] h-[60vw] max-w-[500px] max-h-[500px] bg-white rounded-full mix-blend-soft-light filter blur-[60px] opacity-60 animate-pulse-slow pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[70vw] h-[70vw] max-w-[600px] max-h-[600px] bg-[#111] rounded-full mix-blend-overlay filter blur-[80px] opacity-5 pointer-events-none" />

      <div className="bg-grain" />

      {/* Main Card */}
      <div className="relative z-10 flex flex-col min-h-[100vh] md:min-h-[92vh] w-full md:max-w-5xl bg-rialo-cream/80 backdrop-blur-2xl md:border md:border-white/40 shadow-3d-card md:rounded-3xl overflow-hidden transition-all duration-700 animate-cinematic-fade-in group/card">
        ...
        {/* Chat Area */}
        <main className="flex-1 overflow-y-auto scroll-smooth no-scrollbar relative min-h-0">
